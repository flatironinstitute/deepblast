...
class TestTMAlignDataset(unittest.TestCase):
    ...
    def test_getitem(self):
        ...
        # test the lengths
        self.assertEqual(len(gene), 21 + 2)
        self.assertEqual(len(pos), 21 + 2)
...
class TestMaliDataset(unittest.TestCase):
    ...
    def test_constructor(self):
        x = MaliAlignmentDataset(self.pairs, tokenizer=self.tokenizer)
    ...
    def test_getitem(self):
        ...
        # test the lengths
        self.assertEqual(len(gene[0]), 81 + 2)
        self.assertEqual(len(pos[0]), 81 + 2)
